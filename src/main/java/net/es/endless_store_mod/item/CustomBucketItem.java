...
public class CustomBucketItem extends Item implements FluidModificationItem {
    private final Fluid fluid;

    public CustomBucketItem(Fluid fluid, Item.Settings settings) {
        super(settings);
        this.fluid = fluid;
    }
    ...
    public static ItemStack getEmptiedStack(ItemStack stack, PlayerEntity player) {
        return !player.getAbilities().creativeMode ? new ItemStack(EndlessStoreItems.PLASTIC_BUCKET) : stack;
    }
