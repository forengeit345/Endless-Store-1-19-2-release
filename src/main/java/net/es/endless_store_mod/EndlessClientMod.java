...
import net.es.endless_store_mod.entity.client.EmployeeRenderer;
import net.es.endless_store_mod.entity.client.JackRenderer;
import net.es.endless_store_mod.entity.client.SecurityRenderer;
import net.es.endless_store_mod.entity.client.armor.EmployeeShirtRenderer;
import net.es.endless_store_mod.entity.client.armor.SecurityArmorRenderer;
