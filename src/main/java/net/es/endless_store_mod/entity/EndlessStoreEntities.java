...
public class EndlessStoreEntities {
    public static final EntityType<EmployeeEntity> EMPLOYEE = Registry.register(
            ...
            FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, EmployeeEntity::new)
                    .dimensions(EntityDimensions.fixed(0.8f, 1.85f)).build());
    ...
    public static final EntityType<WatcherEntity> WATCHER = Registry.register(
            Registries.ENTITY_TYPE, new Identifier(EndlessStoreMod.MOD_ID, "watcher"),
            FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, WatcherEntity::new)
                    .dimensions(EntityDimensions.fixed(0.85f, 3.25f)).build());
    public static final EntityType<WaterStriderEntity> WATER_STRIDER = Registry.register(
            Registries.ENTITY_TYPE, new Identifier(EndlessStoreMod.MOD_ID, "water_strider"),
            FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, WaterStriderEntity::new)
