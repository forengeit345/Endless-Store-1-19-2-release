...
public abstract class AcidFluid extends FlowableFluid {
    ...
    public Fluid getFlowing() {
        return EndlessStoreFluids.FLOWING_ACID;
    }

    public Fluid getStill() {
        return EndlessStoreFluids.ACID;
    }

    public Item getBucketItem() {
        return EndlessStoreFluids.PLASTIC_ACID_BUCKET;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) EndlessStoreFluids.ACID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }

    public boolean matchesType(Fluid fluid) {
        return fluid == EndlessStoreFluids.ACID || fluid == EndlessStoreFluids.FLOWING_ACID;
    }
