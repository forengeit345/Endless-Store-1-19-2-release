...
public class PaddedStool extends HorizontalDirectionalBlock {
    ...
    public PaddedStool(Properties properties) {
        super(properties);
    }

    private static final VoxelShape SHAPE = Block.box(0, 0, 0, 16, 12.6, 16);
