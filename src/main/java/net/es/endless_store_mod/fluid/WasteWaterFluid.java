...
public abstract class WasteWaterFluid extends FlowableFluid {
    ...
    @Override
    public int getTickRate(WorldView world) {return 10;}
    ...
    @Override
    public Fluid getStill() {return EndlessStoreFluids.WASTE_WATER;}

    @Override
    public Fluid getFlowing() {return EndlessStoreFluids.FLOWING_WASTE_WATER;}

    @Override
    public Item getBucketItem() {return EndlessStoreFluids.PLASTIC_WASTE_WATER_BUCKET;}

    @Override
    protected BlockState toBlockState(FluidState state) {
        return EndlessStoreFluids.WASTE_WATER_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
