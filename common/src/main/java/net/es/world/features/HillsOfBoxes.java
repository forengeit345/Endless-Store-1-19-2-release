...
public class HillsOfBoxes extends Feature<NoneFeatureConfiguration> {
    ...
    private static final float SECONDARY_BLOCK_CHANCE = 0.4F;
    private static final int CHECK_DEPTH = 5;
    private static final int OCTAVES = 4;
    private static final double BASE_FREQUENCY = 0.155;
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        // Получаем блоки напрямую из реестра – гарантированно зарегистрированы
        ...
        for (int x = -radius; x <= radius; x++) {
            for (int z = -radius; z <= radius; z++) {
                ...
                noiseValue *= (1.0 - distance * distance);
