...
public abstract class AcidFluid extends FlowableFluid {
    ...
    @Override
    public Fluid getStill() {return EndlessStoreFluids.ACID;}

    @Override
    public Fluid getFlowing() {return EndlessStoreFluids.FLOWING_ACID;}

    @Override
    public Item getBucketItem() {return EndlessStoreFluids.PLASTIC_ACID_BUCKET;}

    @Override
    protected BlockState toBlockState(FluidState state) {
        return EndlessStoreFluids.ACID_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
